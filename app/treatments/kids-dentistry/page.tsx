...
export const metadata: Metadata = {
    title: 'Sedation Dentistry for Kids Nallagandla | Painless Pediatric Care',
    description: 'Best Pediatric Dentist in Nallagandla offering Conscious Sedation (Sleep Dentistry) for anxious kids. Gentle, fear-free treatments by our specialists.',
    keywords: ['Sedation Dentistry Nallagandla', 'Kids Dentist Nallagandla', 'Pediatric Dentist', 'Sleep Dentistry for Kids', 'Painless Dental Care'],
    alternates: {
...
export default function KidsDentistryPage() {
    ...
    const t = treatmentsData['kids-dentistry'];
    if (!t) return notFound();

    // Custom Overrides for SEO & Content
    const customTitle = "Sedation Dentistry for Kids";
    const customSubtitle = "Fear-Free Pediatric Care with Conscious Sedation";
    const customDescription = "We specialize in Sedation Dentistry (Sleep Dentistry) to ensure a 100% anxiety-free experience for your child. Perfect for uncooperative or fearful children.";
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-black text-slate-900 dark:text-slate-200 font-sans">
            ...
            <section className="relative h-[60vh] min-h-[500px] flex items-end pb-20 overflow-hidden">
                <Image
                    src={t.heroImage}
                    alt="Sedation Dentistry for Kids Nallagandla"
                    fill
                ...
                <div className="lg:col-span-2 space-y-12">
                    ...
                    <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 shadow-xl border border-slate-100 dark:border-white/5">
                        ...
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed whitespace-pre-line text-lg">
                            ...
                            {t.longDescription}
                            <br /><br />
                            <strong>Why Choose Sedation?</strong> For many children, the dentist can be scary. Our conscious sedation techniques allow your child to relax or sleep through the procedure, waking up with no memory of the treatment and a brand new smile.
                        </p>
                    ...
                    <div className="bg-slate-100 dark:bg-white/5 rounded-3xl p-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-slate-200 dark:border-white/5 hover:border-red-500/30 transition-colors">
                                <h3 className="font-bold text-lg mb-2 flex items-start gap-3">
                                    <span className="text-red-500">Q.</span> Is sedation safe for my child?
                                </h3>
                                <p className="text-slate-500 pl-7">Yes, we strictly follow AAPD guidelines. We use mild Nitrous Oxide (Laughing Gas) or Conscious Sedation, which is extremely safe and wears off quickly.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="lg:col-span-1">
                    <div className="sticky top-8 space-y-6">
                        ...
                        <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 shadow-xl border border-red-100 dark:border-red-900/20 relative overflow-hidden">
                            ...
                            <h3 className="text-xl font-bold mb-2">Book a Sedation Consult</h3>
                            <p className="text-slate-500 mb-6 text-sm">Dr. Dhivakaran is accepting new pediatric patients.</p>
                            ...
                            <div className="mt-6 flex items-center justify-center gap-2 text-xs text-slate-400">
                                <Shield size={12} />
                                <span>Hospital-Grade Safety Protocols</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-50 dark:bg-white/5 rounded-3xl p-8 border border-slate-100 dark:border-white/5">
                            ...
                            <ul className="space-y-4">
                                ...
                                <li className="flex items-start gap-3 text-slate-700 dark:text-slate-300">
                                    <CheckCircle size={18} className="text-green-500 shrink-0 mt-0.5" />
                                    <span className="text-sm font-medium">Safe Sedation Options</span>
                                </li>
                            </ul>
                        </div>

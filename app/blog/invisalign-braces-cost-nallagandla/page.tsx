...
const faqs = [
    ...
    { q: 'Are clear aligners better than braces?', a: 'Aligners are better for mild-moderate cases. Metal braces are superior for complex bite corrections. Dr. Dhivakaran Reddy recommends after examination.' },
...
const jsonLd = {
    '@context': 'https://schema.org', '@graph': [
        { '@type': 'Article', headline: 'Invisalign & Braces Cost in Nallagandla (2026)', author: { '@type': 'Person', name: 'Dr. Dhivakaran Reddy' }, publisher: { '@type': 'Organization', name: 'Noble Dental Care' }, datePublished: '2026-05-05', mainEntityOfPage: `${BASE}/blog/${SLUG}` },

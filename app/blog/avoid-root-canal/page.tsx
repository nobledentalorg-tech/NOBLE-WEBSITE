...
export const metadata = {
    ...
    description: 'Looking for naturally avoiding root canals? Dr. Dhivakaran Reddy explains why antibiotics fail, the hidden costs of extraction, and when you can actually save your tooth.',
};

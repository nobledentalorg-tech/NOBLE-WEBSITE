...
export const metadata = {
    ...
    description: 'Complete smile makeover cost in Hyderabad from ₹15,000 to ₹3L. Veneers, bonding, whitening & aligners combined. Digital Smile Design by Dr. Dhivakaran Reddy. Before/after results.',
...
const faqs = [
    ...
    { q: 'What is included in a smile makeover?', a: 'A smile makeover can include any combination of: teeth whitening, dental veneers, composite bonding, gum contouring, crowns, and aligners. Dr. Dhivakaran Reddy designs a custom plan based on your smile analysis.' },
...
const jsonLd = {
    '@context': 'https://schema.org', '@graph': [
        { '@type': 'Article', headline: 'Smile Makeover Cost in Hyderabad (2026)', author: { '@type': 'Person', name: 'Dr. Dhivakaran Reddy' }, publisher: { '@type': 'Organization', name: 'Noble Dental Care' }, datePublished: '2026-05-06', mainEntityOfPage: `${BASE}/blog/${SLUG}` },

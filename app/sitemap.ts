...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    const staticRoutes = [
        ...
        { path: '/blog/invisalign-braces-cost-nallagandla', priority: 0.9, freq: 'monthly' as const },
        { path: '/blog/teeth-whitening-cost-nallagandla', priority: 0.85, freq: 'monthly' as const },
        { path: '/blog/best-kids-dentist-nallagandla', priority: 0.85, freq: 'monthly' as const },
        { path: '/blog/dental-crown-cap-cost-nallagandla', priority: 0.85, freq: 'monthly' as const },
        { path: '/blog/wisdom-tooth-removal-cost-nallagandla', priority: 0.85, freq: 'monthly' as const },
        { path: '/blog/smile-makeover-cost-hyderabad', priority: 0.85, freq: 'monthly' as const },
        { path: '/blog/full-mouth-implant-cost-hyderabad', priority: 0.9, freq: 'monthly' as const },
        { path: '/blog/teeth-cleaning-scaling-cost-nallagandla', priority: 0.8, freq: 'monthly' as const },
    ].map((route) => ({

...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const CART_STORAGE_KEY = "ndc-pharmacy-cart-v2";
  ...
  if (orderForm) {
    ...
    on(orderForm, "submit", (event) => {
      ...
      const emailSubject = encodeURIComponent(`Noble Dental pharmacy order ${orderId}`);

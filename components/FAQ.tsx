...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: "Do you handle dental emergencies in Nallagandla?",
      answer: "Yes. We reserve daily slots for emergencies (tooth pain, broken crowns) at our clinic above Travancore Ayurveda, Nallagandla. Call 86104 25342 for immediate relief."
    },
    {
      question: "Why choose Noble Dental over corporate chains?",
      answer: "Unbroken Chain of Care. Unlike corporate clinics with rotating staff, Dr. Dhivakaran personally treats every root canal and implant. We are 100% owner-operated, ensuring accountability and consistent quality."
    },
    {

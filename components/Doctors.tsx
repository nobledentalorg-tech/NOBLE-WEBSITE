  ...
  const doctors: Doctor[] = [
    {
      ...
      success: '98%',
      aligners: false,
      bio: 'Dr. Dhivakaran is a pioneer in the field of Dentistry (11+ Years) and a contributor in "Triumph\'s Complete Review of Dentistry". He served at SIIMS Hospital during the COVID crisis and holds multiple WHO certifications. Beyond clinical practice, he drives digital health innovation as the Director of HealthFlo, collaborating with hospitals across India to revolutionize patient care.',
      dciReg: '23853'
    },
    {
      id: 'roger',
